    ...
    <div className="w-full md:max-w-3xl px-4 md:mt-20 animate-reveal">
      ...
      <header className="w-full flex flex-col gap-2 md:bg-neutral-900 md:px-10 pb-4">
        <div className="flex flex-row justify-between items-start">
          ...
          <p className="mt-5 tracking-widest text-neutral-600 border rounded-md px-2 border-neutral-800 text-sm font-medium">
            BETA
          </p>
          <div
            className={`h-14 w-[72px] md:w-20 md:h-20 mr-2 md:mr-0 ${styles.dotGrid}`}
          ></div>
        </div>
